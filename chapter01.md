...
### 중요 개념
* 1.1 : 리눅스, 시스템 프로그래밍, 시스템 호출, 인터페이스
* 1.2 : 유닉스, 시스템V, BSD, 리눅스, ANSI C, POSIX, X/Open 가이드, 단일 유닉스 명세, 시스템 V 인터페이스 정의
* 1.3 : 시스템 프로그래밍, 시스템 호출, 라이브러리 함수, 정적 라이브러리, 공유 라이브러리, man 페이지, errno, 시스템 호출과 라이브러리 함수의 오류 처리
